...
<main class="container">
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm" id="listado">
        <h5 class="border-bottom pb-2 mb-0"><b>MÉTODO DE PAGO - LISTADO</b></h5>
        <div class="p-3">
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm" id="formulario">
        <h5 class="border-bottom pb-2 mb-0"><b>MÉTODO DE PAGO - FORMULARIO</b></h5>
        <form id="frm_form" name="frm_form" method="post">
            ...
            <div class="p-3">
                ...
                <div class="input-group">
                    <input type="text" id="nombre" name="nombre" placeholder="Nombre del método de pago" class="form-control">
                </div>
            </div>
...
<script src="matricula_metodo_pago.js"></script>
<?php
}
ob_end_flush();
?>
