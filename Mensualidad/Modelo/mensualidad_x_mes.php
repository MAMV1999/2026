...
class Mensualidadxmes
{
    ...
    public function listar_frm($id)
    {
        $sql = "SELECT
                ...
                AND md.estado = 1
                ORDER BY il.nombre ASC, inn.nombre ASC, ig.nombre ASC, isec.nombre ASC,
                        ua2.nombreyapellido ASC, md.pagado ASC";
        return ejecutarConsulta($sql);
    }
}
