var link = "../Controlador/mensualidad_x_grado.php?op=";
var tabla;
...
function mostrar(id_grado) {
    $.post(link + "mostrar", { id_grado: id_grado }, function (data) {
        ...
        detalles.forEach((detalle, index) => {
            ...
            let filaMeses = idsMeses.map((idMes, i) => {
                let observacion = observaciones[i] ? observaciones[i] : "";
                ...
                return `
                    <tr>
                        ...
                        <td style="width: 25%; height: auto;">
                            <input type="text" class="form-control" name="monto-${idMes}" value="${montos[i]}" />
                        </td>

                        <td style="width: 25%; height: auto;">
                            <div class="form-check form-check-inline">
                                <input type="radio" 
                                       name="pagado-${index}-${idMes}" 
                                       value="1" 
                                       ${estadosPago[i] === "1" ? "checked" : ""} 
                                       class="form-check-input estado-pago-radio" 
                                       data-id="${idMes}">
