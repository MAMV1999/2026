...
<main class="container">
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm" id="listado">
        <h5 class="border-bottom pb-2 mb-0"><b>CATEGORÍA - LISTADO</b></h5>
        <div class="p-3">
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm" id="formulario">
        <h5 class="border-bottom pb-2 mb-0"><b>CATEGORÍA - FORMULARIO</b></h5>
...
<script src="almacen_categoria.js"></script>
<?php
}
ob_end_flush();
?>