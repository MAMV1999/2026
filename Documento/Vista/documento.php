                ...
                <div class="p-3">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="documento-tab-pane" role="tabpanel" aria-labelledby="documento-tab">
                            <div class="p-3">
                                <label for="id_documento_responsable" class="form-label"><b>RESPONSABLE:</b></label>
                                <select id="id_documento_responsable" name="id_documento_responsable" class="form-control" data-live-search="true"></select>
                            </div>
